...
for n in N2N:
    ...
    print "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><div id=PNBTitle>%s</div><td>&nbsp;</td><td><a href='../../Controllers/RemoveNet2Net.cgi?nid=%s&uid=%s&sid=%s&remote=%s&net2net=%s'><div id=PNButton>Remove</div></a></td><td>&nbsp;&nbsp;&nbsp;</td>"%(n[2], nid, uid, sid, remote, n[0])
